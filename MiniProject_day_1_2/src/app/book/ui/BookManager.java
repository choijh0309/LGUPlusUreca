...
public class BookManager extends JFrame {
	...
	public BookManager() {
		...
		addButton.addActionListener(e -> { // event 객체를 받아서 처리하는 로직을 가진 객체 <= ActionListener interface 를 구현해야 한다.
			// AddBookDialog 를 띄운다.
		...
		editButton.addActionListener(e -> { // event 객체를 받아서 처리하는 로직을 가진 객체 <= ActionListener interface 를 구현해야 한다.
	...
	public static void main(String[] args) {
		...
		// invokeLater( thread 객체 <- runnable interface 를 구현한 <- runnable interface 가
